...
<template>
  <div class="content">
    ...
    <el-dialog title="收货地址" :visible.sync="dialogTableVisibleMonth">
      <el-table :data="gridData">
        <el-table-column property="date" label="日期132" width="150"></el-table-column>
        <el-table-column property="name" label="姓名" width="200"></el-table-column>
        <el-table-column property="address" label="地址"></el-table-column>
      </el-table>
    </el-dialog>
        ...
        <div @click="dialogTableVisibleDate = true">
          <el-card shadow="hover" :body-style="{ padding: '0px' }">
            <div class="grid-content grid-con-1">
              <el-icon class="grid-con-icon el-icon-user-solid">
              </el-icon>
        ...
        <div @click="dialogTableVisibleMonth = true" >
          <el-card shadow="hover" :body-style="{ padding: '0px' }">
            <div class="grid-content grid-con-2">
              <el-icon class="grid-con-icon el-icon-eleme">
              </el-icon>
              <div class="grid-cont-right">
                <div class="grid-num">1234</div>
                <div>本月分数</div>
