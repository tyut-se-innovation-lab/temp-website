...
| -------- | -------- | ----- | -------- | -------- | ------ |
|userId|userId|query|true|integer(int64)||
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|scoreCheck|scoreCheck|query|true|integer(int64)||
|pageNum|pageNum|query|false|integer(int32)||
|pageSize|pageSize|query|false|integer(int32)||
...
|startTime|startTime|query|true|string(date-time)||
