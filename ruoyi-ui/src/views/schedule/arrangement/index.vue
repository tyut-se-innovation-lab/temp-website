          ...
          this.tableData.push(
            {
              data: `第${k + 1}节课`,
              week: {
                Mon: this.displaymessage(1, k + 1),
                Tue: this.displaymessage(2, k + 1),
                Wed: this.displaymessage(3, k + 1),
                Thu: this.displaymessage(4, k + 1),
                Fir: this.displaymessage(5, k + 1),
                Sat: this.displaymessage(6, k + 1),
                Sun: this.displaymessage(7, k + 1)
              }
            }
          )
        }
